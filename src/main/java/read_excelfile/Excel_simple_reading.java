...
public class Excel_simple_reading {
	...
	@Test
	public void read_excel_file1() throws IOException {
	
	String path = "C:\\Users\\Administrator\\Desktop\\Testing.xls";
	FileInputStream fis = new FileInputStream(path);
	Workbook workbook = new HSSFWorkbook(fis);
	Sheet sheet = workbook.getSheet("Dora");
	...
	//Pick up the test data as per Test Case Name + Column Name
	@Test
	public void read_excel_file2(String testName, String columnName ) throws IOException {
...
//Complete Code for dynamic XL read as per condition
	@Test
